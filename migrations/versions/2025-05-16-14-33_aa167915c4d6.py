...
# Frozen copy of maintenance_window.DEFAULT_ALERT_STATUSES_TO_IGNORE as it stood
# when this revision was written. A migration must not import a live model: the
# constant can change, and then what this revision does to a fresh database
# changes with it, retroactively.
DEFAULT_ALERT_STATUSES_TO_IGNORE = ["resolved", "acknowledged"]
